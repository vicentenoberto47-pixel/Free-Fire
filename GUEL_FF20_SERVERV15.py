...
GUILDA_ID = "50001"
SERVER_NAME = "GUEL_FF20_SERVERV15"
...
class FreeFireV15Handler(http.server.BaseHTTPRequestHandler):
    def get_db(self):
        default_db = {
    ...
    def do_POST(self):
        ...
        if "login" in self.path or "guest_login" in self.path:
            ...
            response = {
                ...
                "session_key": "guelff_v15_render_" + hashlib.md5(player_id.encode()).hexdigest()[:8]
            }
...
if __name__ == "__main__":
    ...
    print(f"====================================================")
    with ReusableTCPServer(("", PORT), FreeFireV15Handler) as httpd:
        httpd.serve_forever()
